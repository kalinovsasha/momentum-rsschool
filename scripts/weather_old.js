...
async function getWeather(city = "Минск", lang = "en") {
  const url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&lang=${lang}&appid=30553990b6cf3eb6a168aefb3ad6ebb5&units=metric`;
